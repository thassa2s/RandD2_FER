...
void GFExtractorOnImage::extractFeaturesOnImage(IplImage *image,
												vector1Df &gFV)
{
	const int numberOfLambdas = 5;
	const int numberOfOrientations = 8;
	
	float lambda[numberOfLambdas] = {3.5, 4.5, 7.5, 10.5, 15.5};
	float orientation[numberOfOrientations] = {0, 22.5, 45, 67.5, 90, 112.5, 135, 157.5};
...
void GFExtractorOnImage::fillGaborFeatureVector(	IplImage *magresp, 
																									vector1Df &gFV	)
{	
